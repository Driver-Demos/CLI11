...
Catch2, CMake, and Meson tests for CLI11 parsing, formatting, encoding, and build setup
...
- **[fuzzFail](fuzzFail/README.md)**: Fuzz-failure test inputs for malformed CLI argument parsing and parse error cases.
