...
Tests for CLI11 library functionality, build configurations, encoding, parsing, and error handling.

## Folders
- **[applications](applications/README.md)**: Tests for ensuring UTF-8 encoding of command-line arguments using the `CLI::App` class.
- **[data](data/README.md)**: Unicode text file with accented letters, Cyrillic, Chinese characters, and emojis.
- **[find_package_tests](find_package_tests/README.md)**: CMake project setup for testing CLI11 package configuration and target linking.
- **[fuzzFail](fuzzFail/README.md)**: Test input files for fuzz testing, containing malformed or non-standard data and command-line arguments.
- **[mesonTest](mesonTest/README.md)**: Demonstrates a CLI11-based command-line app setup with Meson build instructions and configuration.
- **[package_config_tests](package_config_tests/README.md)**: CMake project setup for testing CLI11 package configuration, linking, and output validation.
- **[tests](tests/README.md)**: Empty file (no analyzable contents).
