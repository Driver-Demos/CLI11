...
Examples of CLI applications using the CLI11 library, including subcommands, argument parsing, and custom formatting.

## Folders
- **[subcom_in_files](subcom_in_files/README.md)**: Build configuration and implementation of a CLI application with subcommands using CLI11.
