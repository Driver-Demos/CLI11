...
Build, docs, tests, and configuration for a header-only C++ command-line parser
...
- **[docs](docs/README.md)**: Doxygen configuration and main page for CLI11 API documentation
...
- **[tests](tests/README.md)**: Catch2, CMake, and Meson tests for CLI11 parsing, formatting, encoding, and build setup
