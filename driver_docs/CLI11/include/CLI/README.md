...
Inline implementations for command-line parsing and related tasks, with headers for app management, argument handling, configuration, encoding, error management, formatting, macros, options, string tools, timing, type tools, validators, and versioning.

## Folders
- **[impl](impl/README.md)**: Inline implementations for command-line parsing, configuration, encoding, formatting, options, splitting, string tools, and validators.
